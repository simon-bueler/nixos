      ...
      ''
        {
          ...
          "menus.dashboard.directories.left.directory2.label": "󰉏 Bilder",
          "menus.dashboard.directories.left.directory2.command": "bash -c \"thunar $HOME/Bilder/\"",
          "menus.dashboard.directories.left.directory3.label": "󱧶 Dokumente",
          "menus.dashboard.directories.left.directory3.command": "bash -c \"thunar $HOME/Dokumente/\"",
